from text_diff.extract_diff import (
    AddedLine,
    ModifiedLine,
    RemovedLine,
    TextDifferences,
...
def test_text_differences():
    ...
    res = text_differences(text_1, text_2)
...
def test_build_difflines():
    input_ = [
        ...
        '?             ^\n',
        "  -sont implantés hors des zones d'effet thermique d'intensité supérieure à 5 kW/ m2 ide"
        "ntifiées dans l'étude de dangers, ou ;",
        "  -sont constitués de matériaux résistant aux effets générés par les accidents identifié"
        "s dans l'étude de dangers et susceptibles de conduire à leur emploi.",
    ...
    assert res == [
        ...
        UnchangedLine(
            content="-sont implantés hors des zones d'effet thermique d'intensité supérieure à 5 kW"
            "/ m2 identifiées dans l'étude de dangers, ou ;"
        ),
        UnchangedLine(
            content="-sont constitués de matériaux résistant aux effets générés par les accidents i"
            "dentifiés dans l'étude de dangers et susceptibles de conduire à leur emploi."
        ),
    ...
    input_ = [
        ...
        "  -sont implantés hors des zones d'effet thermique d'intensité supérieure à 5 kW/ m2 ide"
        "ntifiées dans l'étude de dangers, ou ;",
        "  -sont constitués de matériaux résistant aux effets générés par les accidents identifiés"
        " dans l'étude de dangers et susceptibles de conduire à leur emploi.",
        "  ## 43-3. Moyens en eau, émulseurs et taux d'application.",
    ]
    res = _build_difflines(input_)
